---
slug: hitcon-ctf-2016-quals-flame-150
title: "[HITCON CTF 2016 Quals] flame 150"
description: "[HITCON CTF 2016 Quals] flame 150 解題紀錄，整理題目分析、漏洞成因、利用方式與解題流程。"
pubDate: "2016-10-14"
authors:
  - bruce30262
category: Write-up
...
language: zh-Hant
legacy: true
legacySource: https://github.com/bamboofox/bamboofox-blog-old/blob/master/_posts/2016-10-14-HITCON-CTF-2016-Quals-flame-150.md
legacyPath: "/write-ups/2016/10/14/HITCON-CTF-2016-Quals-flame-150.html"
---
...
題目給了我們一隻 binary, 32 bit PowerPC ELF 這題運氣不錯，打 CTF 用的 docker image 裡面剛好有裝 `qemu-ppc-static`，加上這題剛好是一隻 static linked 的 binary, 不需要再額外裝 PPC 的 libc，因此透過以下 command 即可將 binary run 起來:
