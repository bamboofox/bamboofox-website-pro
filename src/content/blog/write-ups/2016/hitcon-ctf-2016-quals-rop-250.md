---
slug: hitcon-ctf-2016-quals-rop-250
title: "[HITCON CTF 2016 Quals] ROP 250"
description: "[HITCON CTF 2016 Quals] ROP 250 解題紀錄，整理題目分析、漏洞成因、利用方式與解題流程。"
pubDate: "2016-10-14"
authors:
  - bruce30262
category: Write-up
...
language: zh-Hant
legacy: true
legacySource: https://github.com/bamboofox/bamboofox-blog-old/blob/master/_posts/2016-10-14-HITCON-CTF-2016-Quals-ROP-250.md
legacyPath: "/write-ups/2016/10/14/HITCON-CTF-2016-Quals-ROP-250.html"
---
...
題目給了我們一個叫做 `rop.iseq` 的檔案查過 file header 之後，發現是 [Ruby InstructionSequence](https://ilconnettivo.wordpress.com/2015/12/25/ruby-2-3-0-instructionsequence/) 的 binary 格式。
...
這邊開始變得比較複雜。首先程式會 call 函式`f(217, key[2].to_i(16), 314159)`，其回傳值的 **28 進位**要等於 48D5 ( 換算成 10 進位的話是 94449 )。而 `f` 這個函式做的事情有點複雜，這邊就只列 pseudo code:
